    ...
    return (
        ...
        <>
            <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
                <div className="flex items-center gap-2 text-sm text-green-600 bg-blue-400/10 border border-indigo-200 rounded-full px-6 py-1.5">
                    <BookUserIcon className="size-4.5 stroke-green-600"/>
                    <span>Testimonials</span>
                </div>

                <Title title = "Build Smarter Resumes with AI" description="Let AI craft, optimize and refine your resume so you stand out and get noticed faster." />
                <br />
            </div>
            <style>{`

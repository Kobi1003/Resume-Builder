...
const Features = () => {
    ...
    return (
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
            ...
            <div className="flex items-center gap-2 text-sm text-green-600 bg-blue-400/10 border border-indigo-200 rounded-full px-4 py-1">
                <svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        stroke="#0f6312" strokeMiterlimit="5.759" strokeLinecap="round" />
                </svg>
